...
urlpatterns = [
    ...
    path('protector/home_protector/', views.home_protector, name='home_protector'),
    path('senior/home_senior/', views.home_senior, name='home_senior'),
    ...
    path('protector/tip/', views.tip, name='tip'),
]
